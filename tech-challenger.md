...
* **Formato:** Atividade em grupo.
* **Avaliação:** Obrigatória, valendo 90% da nota de todas as disciplinas da fase.
...
**Sendo assim, escolha pelo menos três das opções abaixo:**
...
4.  Utilizar serviços em nuvem para ampliar capacidade de processamento especializado.
5.  Aplicar técnicas de detecção de anomalias em tempo real para monitoramento preventivo específico.
...
* **YOLOv8 customizado** para detecção de um dos itens abaixo (escolha uma opção ou proponha uma):
...
* Demonstração do processamento multimodal:
    ...
    * Fluxo final do alerta à equipe médica.# POS TECH - Tech Challenge
